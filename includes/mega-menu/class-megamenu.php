...
require_once( K2_INCLUDES.'mega-menu/class-megamenu-walker.php');
class EFramework_MegaMenu_Register
{
    ...
    {
        $labels = array(
            'name'                  => _x('Mega Menus', 'Post Type General Name', K2_TEXT_DOMAIN),
            'singular_name'         => _x('Mega Menu', 'Post Type Singular Name', K2_TEXT_DOMAIN),
            'menu_name'             => __('Mega Menus', K2_TEXT_DOMAIN),
            'name_admin_bar'        => __('Mega Menus', K2_TEXT_DOMAIN),
            'archives'              => __('Item Archives', K2_TEXT_DOMAIN),
            'parent_item_colon'     => __('Parent Item:', K2_TEXT_DOMAIN),
            'all_items'             => __('All Items', K2_TEXT_DOMAIN),
            'add_new_item'          => __('Add New Mega Menu', K2_TEXT_DOMAIN),
            'add_new'               => __('Add New', K2_TEXT_DOMAIN),
            'new_item'              => __('New Mega Menu', K2_TEXT_DOMAIN),
            'edit_item'             => __('Edit Mega Menu', K2_TEXT_DOMAIN),
            'update_item'           => __('Update Mega Menu', K2_TEXT_DOMAIN),
            'view_item'             => __('View Mega Menu', K2_TEXT_DOMAIN),
            'search_items'          => __('Search Mega Menu', K2_TEXT_DOMAIN),
            'not_found'             => __('Not found', K2_TEXT_DOMAIN),
            'not_found_in_trash'    => __('Not found in Trash', K2_TEXT_DOMAIN),
            'featured_image'        => __('Featured Image', K2_TEXT_DOMAIN),
            'set_featured_image'    => __('Set featured image', K2_TEXT_DOMAIN),
            'remove_featured_image' => __('Remove featured image', K2_TEXT_DOMAIN),
            'use_featured_image'    => __('Use as featured image', K2_TEXT_DOMAIN),
            'insert_into_item'      => __('Insert into item', K2_TEXT_DOMAIN),
            'uploaded_to_this_item' => __('Uploaded to this item', K2_TEXT_DOMAIN),
            'items_list'            => __('Items list', K2_TEXT_DOMAIN),
            'items_list_navigation' => __('Items list navigation', K2_TEXT_DOMAIN),
            'filter_items_list'     => __('Filter items list', K2_TEXT_DOMAIN),
        );
        $args = array(
            'label'               => __('Mega Menu', K2_TEXT_DOMAIN),
            'labels'              => $labels,
    ...
    function edit_nav_menu_walker( $walker, $menu_id ) {
        if ( ! class_exists( 'EFramework_Mega_Menu_Edit_Walker' ) ) {
            require_once( K2_INCLUDES . 'mega-menu/class-mega-menu-edit.php' );
        }
