...
if (!class_exists('EFramework_menu_handle')) {
    class EFramework_menu_handle
    {
        ...
        public function cms_add_menu()
        {
            ...
            add_submenu_page($this->theme_text_domain, $this->theme_name, esc_html__('Dashboard', K2_TEXT_DOMAIN), 'manage_options', $this->theme_text_domain, array($this, 'cms_create_theme_dashboard'));

        }

        public function cms_create_theme_dashboard()
        {
            include_once k2core()->path('APP_DIR', 'templates/dashboard/dashboard.php');
        }
        ...
        function cms_add_admin_bar_menu($wp_admin_bar)
        {
            ...
            $args = array(
                'id'     => 'dashboard',
                'title'  => esc_html__('Dashboard', K2_TEXT_DOMAIN),
                'href'   => admin_url('admin.php?page=' . $theme->get("TextDomain")),
            ...
            if (class_exists('SWA_Import_Export')) {
                $args = array(
                    ...
                    'title'  => esc_html__('Import Demos', K2_TEXT_DOMAIN),
            ...
            if ( class_exists( 'ReduxFramework' ) ){
                $args = array(
                    'id'     => 'theme-options',
                    'title'  => esc_html__('Theme Options', K2_TEXT_DOMAIN),
